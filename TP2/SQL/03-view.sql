...
-- Description : Affiche la liste des entreprises externes possédant des employés à risque de contaminer leur établissement après leur visite dans la compagnie G2BUqamInc entre le 1er mai et le 30 juin 2021 ainsi que la date de l'alerte pour chacun de leur employé en plus d'afficher les symptômes et la température des personnes contaminée. De plus, leur numéro d'assurance sociale (id_personne), ville, numéro d'adresse et code postal pour les services médicaux. L'affichage est groupé par nom d'entreprise externe et trié par date des alertes des plus récentes au plus anciennes.
